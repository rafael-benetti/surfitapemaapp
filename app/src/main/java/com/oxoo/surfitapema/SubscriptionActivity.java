...
import com.oxoo.surfitapema.adapters.ActiveSubscriptionAdapter;
import com.oxoo.surfitapema.adapters.InactiveSubscriptionAdapter;
...
import com.oxoo.surfitapema.network.model.ActiveSubscription;
import com.oxoo.surfitapema.network.model.SubscriptionHistory;
...
public class SubscriptionActivity extends AppCompatActivity implements ActiveSubscriptionAdapter.OnItemClickLiestener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("Minha Inscrição");
