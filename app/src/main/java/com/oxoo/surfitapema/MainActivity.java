...
import com.oxoo.surfitapema.adapters.NavigationAdapter;
import com.oxoo.surfitapema.database.DatabaseHelper;
import com.oxoo.surfitapema.fragments.LiveTvFragment;
import com.oxoo.surfitapema.fragments.MoviesFragment;
import com.oxoo.surfitapema.fragments.TvSeriesFragment;
import com.oxoo.surfitapema.models.NavigationModel;
import com.oxoo.surfitapema.nav_fragments.CountryFragment;
import com.oxoo.surfitapema.nav_fragments.FavoriteFragment;
import com.oxoo.surfitapema.nav_fragments.GenreFragment;
import com.oxoo.surfitapema.nav_fragments.MainHomeFragment;
...
import com.oxoo.surfitapema.utils.SpacingItemDecoration;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter.setOnItemClickListener(new NavigationAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, NavigationModel obj, int position, NavigationAdapter.OriginalViewHolder holder) {
                ...
                //----------------------action for click items nav actions menu lateral side bar---------------------
               ...
               // (este é o cameras sai) else if (position==3){
                    ...
                    //        Intent intent=new Intent(MainActivity.this, DownloadActivity.class);
                     ...
                     //   }
                            ...
                            new MaterialAlertDialogBuilder(MainActivity.this)
                                    .setMessage("Você gostaria de Sair ?")
...
/*    @Override
    ...
    public void onBackPressed() {
        ...
        if (mDrawerLayout.isDrawerOpen(GravityCompat.START)){
            ...
            new AlertDialog.Builder(MainActivity.this).setMessage("Você realmente quer sair ?")
                    .setPositiveButton("SIM", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
        ...
        switch (requestCode) {
            case PERMISSION_REQUEST_CODE:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    Log.e("value", "Permissão concedida, agora você pode usar a unidade local .");

                    // creating the download directory named oxoo
                    createDownloadDir();

                } else {
                    Log.e("value", "Permissão negada, você não pode usar a unidade local\n .");
                }
                break;
        }
    }
