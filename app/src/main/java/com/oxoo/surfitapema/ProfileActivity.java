...
import com.oxoo.surfitapema.network.apis.DeactivateAccountApi;
import com.oxoo.surfitapema.network.apis.ProfileApi;
import com.oxoo.surfitapema.network.apis.SetPasswordApi;
import com.oxoo.surfitapema.network.apis.UserDataApi;
import com.oxoo.surfitapema.network.model.ResponseStatus;
import com.oxoo.surfitapema.network.model.User;

import com.oxoo.surfitapema.utils.Constants;
import com.oxoo.surfitapema.utils.FileUtil;
...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        genderArray[0] = "Masculino";
        genderArray[1] = "Feminino";
        genderSpinner.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                builder.setTitle("Selecione o gênero");
        ...
        call.enqueue(new Callback<ResponseStatus>() {
            ...
            public void onResponse(Call<ResponseStatus> call, retrofit2.Response<ResponseStatus> response) {
                if (response.code() == 200) {
                    ...
                    if (resStatus.getStatus().equalsIgnoreCase("Feito Brou")) {
                        logoutUser();
                    ...
                    new ToastMsg(ProfileActivity.this).toastIconError("Feito Brou");
                    alertDialog.dismiss();
                }
            }
